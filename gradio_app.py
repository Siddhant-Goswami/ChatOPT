...
def ask_questions(mission_statement: str, company_name: str, industry: str, business_size: str) -> List[str]:
    """Get follow-up questions based on the initial information"""
    payload = {
...
with gr.Blocks(title="ChatOPT - API Masterplan Generator") as demo:
    gr.Markdown("# ChatOPT - API Masterplan Generator")
